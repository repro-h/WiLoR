...
_C.MODEL.JOINT_REFINEMENT = CN(new_allowed=True)
_C.MODEL.JOINT_REFINEMENT.ENABLED = False
_C.MODEL.JOINT_REFINEMENT.NUM_JOINTS = 21
_C.MODEL.JOINT_REFINEMENT.HIDDEN_DIM = 256
_C.MODEL.JOINT_REFINEMENT.WINDOW_SIZE = 9
_C.MODEL.JOINT_REFINEMENT.SEARCH_RADIUS = 0.125
_C.MODEL.JOINT_REFINEMENT.BACKBONE_WIDTH = 192
_C.MODEL.JOINT_REFINEMENT.TEMPERATURE = 1.0
_C.MODEL.JOINT_REFINEMENT.DETACH_PRIOR = True
_C.MODEL.JOINT_REFINEMENT.DETACH_FEATURES = True
_C.MODEL.JOINT_REFINEMENT.LOSS_WEIGHT = 1.0
_C.MODEL.JOINT_REFINEMENT.UV_LOSS_WEIGHT = 1.0
_C.MODEL.JOINT_REFINEMENT.HEATMAP_LOSS_WEIGHT = 1.0
_C.MODEL.JOINT_REFINEMENT.DELTA_LOSS_WEIGHT = 0.01
_C.MODEL.JOINT_REFINEMENT.SMOOTH_L1_BETA = 0.01
_C.MODEL.JOINT_REFINEMENT.HEATMAP_SIGMA = 0.025
